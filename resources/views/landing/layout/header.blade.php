...
<head>
 ...
 <script src="js/respond.min.js"></script>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144"
        href="{{ asset('multicolor/images/ico/apple-touch-icon-144-precomposed.png') }}">
    <link rel="apple-touch-icon-precomposed" sizes="114x114"
        href="{{ asset('multicolor/images/ico/apple-touch-icon-114-precomposed.png') }}">
    <link rel="apple-touch-icon-precomposed" sizes="72x72"
        href="{{ asset('multicolor/images/ico/apple-touch-icon-72-precomposed.png') }}">
    <link rel="apple-touch-icon-precomposed"
        href="{{ asset('multicolor/images/ico/apple-touch-icon-57-precomposed.png') }}">
</head>
<!--/head-->
